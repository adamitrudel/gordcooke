...
<Title>Gord Cooke | Book Gord</Title>
...
<div id="header-inner"><img src="images/headers/book-gord.jpg" alt="Contact" width="980" height="96" /></div>
    ...
    <div id="theform">
      <form id="form" name="form" method="post" action="">
        <p>
          <label>Name:</label>
          <br />
          <input type="text" name="textfield" id="textfield" style="margin-top:5px;width:170px;" />
        </p>
        <p>
          <label>Email:</label>
          <br />
          <input type="text" name="textfield2" id="textfield2" style="margin-top:5px;width:170px;" />
        </p>
        <p>
          <label>Comments:</label>
          <br />
          <textarea name="textfield3" rows="5" id="textfield3" style="margin-top:5px;width:320px;"></textarea>
          <br />
        </p>
