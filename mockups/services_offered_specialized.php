...
<Title>Gord Cooke | Services Offered - Specialized air quality testing</Title>
...
<div id="container_inner">
	...
	<div id="inner_col-left">
	  <div id="subsubmenu">
	    <ul>
	      ...
	      <li><a href="services_offered_specialized.php"><strong>SPECIALIZED AIR QUALITY TESTING</strong></a></li>
	...
	<div id="inner_col-right">
      <h1><img src="images/inner_photos/success-stories.jpg" width="169" height="312" align="right" />SPECIALIZED AIR QUALITY TESTING</h1>
<p>Some air quality problems are the result of complex and often hidden problems. In these cases, Gord Cooke offers, in cooperation with certified laboratories : 
</p>
       <ul>
         <li>Mold Testing           </li>
         <li>Volatile Organic Compound Testing           </li>
         <li>Combustion Products Analysis           </li>
         <li>Particulate Matter Identification           </li>
         <li>Material Testing</li></ul>
  </div>
<div style="clear:both;"></div>
</div>
