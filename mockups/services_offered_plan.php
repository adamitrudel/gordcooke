...
<Title>Gord Cooke | Services Offered - Plan &amp; specifications review</Title>
...
<div id="container_inner">
	...
	<div id="inner_col-left">
	  <div id="subsubmenu">
	    <ul>
	      ...
	      <li><a href="services_offered_plan.php"><strong>PLAN &amp; SPECIFICATIONS REVIEW</strong></a></li>
	...
	<div id="inner_col-right">
      <h1><img src="images/inner_photos/success-stories.jpg" width="169" height="312" align="right" />PLAN & SPECIFICATIONS REVIEW</h1>
<p>An average home consists of 15,000 building components that are put together by over 200 different people from 14 different trades. But a home is much more than an assembly of parts. A home is an interactive system and each of its components must be designed to work together. During a plan review, Gord analyzes the following components with the “Systems Approach” in mind :</p>
      <ul>
        <li> 	Foundations</li>
        <li> Water Management Details        </li>
        <li>Walls          </li>
        <li>Roofs</li>
        <li> Insulation          </li>
        <li>Air Sealing          </li>
        <li>HVAC </li></ul>
       <p>Extensive system review, material recommendations and design assistance (followed by proper installation) ensure that each home operates as efficiently and effectively as possible.</p>
  </div>
<div style="clear:both;"></div>
</div>
