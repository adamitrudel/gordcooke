...
<Title>Gord Cooke | What's up with Gord</Title>
...
<div id="header-inner"><img src="images/headers/whatsup.jpg" alt="Contact" width="980" height="96" /></div>
<div id="inner_col-left"> <a href="book-gord.php"><img src="images/left-col/icon_book-gord.gif" alt="Book Gord" width="156" height="83" style="margin-top:5px;" /></a> <a href="meet-gord.php"><img src="images/left-col/icon_meet-gord.gif" alt="Book Gord" width="156" height="83" style="margin-top:5px;" /></a> <a href="read-gord.php"><img src="images/left-col/icon_read-gord.gif" alt="Book Gord" width="156" height="83" style="margin-top:5px;" /></a> <a href="whatsup-gord.php"><img src="images/left-col/icon_whatsup-gord.gif" alt="Book Gord" width="156" height="83" style="margin-top:5px;" /></a> </div>
<div id="inner_col-right">
  <h1><img src="images/inner_photos/success-stories.jpg" width="169" height="312" align="right" />LOREM IPSUM IS SIMPLY TEXT</h1>
      <p>And typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into typesetting, remaining essentially unchanged.</p>
      <ul>
        <li> And typesetting</li>
        <li>Lorem Ipsum has been the industry's standard dummy text ever</li>
        <li>It has survived not only five</li>
