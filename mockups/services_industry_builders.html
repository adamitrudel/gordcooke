...
<Title>Gord Cooke | Industry Specific Benefits - Builders</Title>
		  ...
		  <div class="button" style="padding:0px;width:130px;text-align:center;">
			...
			">services</a>
				<div id="sub_services" style="display:block;visibility:visible;">
					...
					<div class="sm" style="background-image:url(images/bg_sm-over.png);"><a href="/services_industry_associations.php">Industry-specific benefits</a></div>
...
<div id="container_inner">
	<div id="header-inner"><img src="images/headers/industry.jpg" alt="Contact" width="980" height="96" /></div>
	<div id="inner_col-left">
	  <div id="subsubmenu">
	    <ul>
	      <li><a href="services_industry_associations.php">ASSOCIATIONS</a></li>
	      <li><a href="services_industry_builders.php"><strong>BUILDERS</strong></a></li>
	      <li><a href="services_industry_manufacturers.php">MANUFACTURERS</a></li>
	      <li><a href="services_industry_utilities.php">UTILITIES &amp; GOVERNMENT AGENCIES</a></li>
	      <li><a href="services_industry_supliers.php">SUPPLIERS &amp; TRADE CONTRACTORS</a></li>
        </ul>
      </div>
  </div>
	<div id="inner_col-right">
   <h1><img src="images/inner_photos/success-stories.jpg" width="169" height="312" align="right" />BUILDERS </h1>
         <ul>
           <li>Sales training on how to effectively educate and sell high performance features and benefits to home buyers
           </li>
           <li>Energy rating for programs such as ENERGY STAR for New Homes, LEED for Homes, GreenHouse and Built Green             </li>
           <li>Air quality evaluation – specifically assessing clean up requirements for mold             </li>
           <li>Heating, cooling and ventilation system design             </li>
           <li>Consultation on finding cost effective ideas for improving durability and energy efficiency             </li>
           <li>Assistance with developing marketing messages for high performance homes             </li>
           <li>Resolving building code issues             </li>
           <li>Technical training of site staff and trades on high performance products and techniques             </li>
           <li>Benchmarking current construction practices and developing a plan for technical improvement.             </li>
           <li>Trouble-shooting and complaints resolution with complex building science issues and product performance.</li></ul>
  </div>
<div style="clear:both;"></div>
</div>
...
<div id="footer">
	<div id="footermenu">
		<div id="footertxt">
			<a href="/index.php">Home</a> | <a href="/profile_biography.php">Profile</a> | <a href="/services_offered_siteassessments.php">Services</a> | <a href="cooke-report.php">Cooke Report</a> | <a href="events_calendar.php">Events</a> | <a href="media-room_news.php">Media Room</a> | <a href="contact-us.php">Contact Us</a> | <a href="sitemap.php">Site Map</a> | <a href="privacy-policy.php">Privacy Policy</a><br/><br/>
