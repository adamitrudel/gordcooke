...
<Title>Gord Cooke | Sign-up for events</Title>
...
<div id="logo"><a href="/index.php" title="Gord Cooke - Building Knowledge"><img src="/images/logo.gif" alt="Gord Cooke - Building Knowledge" width="171" height="130" /></a></div>
	<div id="menu_container">
      ...
      <a href="#" onmouseover="
			...
			MM_changeProp('sub_media','','visibility','hidden','DIV')
			">events</a>
				<div id="sub_events" style="display:block;visibility:visible;">
					<div class="sm"><a href="/events_calendar.php">Events calendar</a></div>
					<div class="sm" style="background-image:url(images/bg_sm-over.png);"><a href="/events_signup.php">Sign-up for an event</a></div>
				</div>
			</div>
...
<div id="header-inner"><img src="images/headers/events.jpg" alt="Contact" width="980" height="96" /></div>
...
<div id="inner_col-right">
  <h1>SIGN-UP FOR EVENTS</h1>
    <p>Simply complete the form below to register for a Cooke Report Event in your area. </p>
</div>
<div style="clear:both;"></div>
</div>
