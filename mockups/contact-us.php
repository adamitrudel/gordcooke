...
<Title>Gord Cooke | Contact</Title>
...
<div id="header-inner"><img src="images/headers/contact.jpg" alt="Contact" width="980" height="96" /></div>
...
<h1>CONTACT US</h1>
      <p>Do you have questions, comments or require additional information? 
If so, we encourage you to contact us. 
</p>
      
      <div id="contact_form-box">
      	
        <div id="theform">
          <form id="form" name="form" method="post" action="">
            <p><label>Name:</label><br /><input type="text" name="textfield" id="textfield" style="margin-top:5px;width:170px;" /></p>
            <p><label>Email:</label><br /><input type="text" name="textfield2" id="textfield2" style="margin-top:5px;width:170px;" /></p>
            <p><label>Comments:</label><br /><textarea name="textfield3" rows="5" id="textfield3" style="margin-top:5px;width:320px;"></textarea>
              <br />
            </p>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="25"><input type="checkbox" name="checkbox" id="checkbox" /></td>
                <td><span class="smalltxt">Yes, I would like to receive information<br />
on upcomin events and company news. </span></td>
                <td width="80" style="padding-right:20px;"><input name="button" type="image" id="button" value="Submit" src="images/b_submit_inner.gif" /></td>
              </tr>
            </table>
        ...
        <div id="contact-info">
          <h2>GORD COOKE</h2>
          <p>Building Technologies<br />
          <br />
          240 Holiday Inn Drive, Suite K,<br />
          Cambridge, Ontario N3C 3X4<br />
          <br />
          T: 519 658 6232 / 800 267 6830<br />
          F: 519 658 6103<br />
          <br />
          <a href="mailto:info@gordcooke.com">info@gordcooke.com</a><br />
          </p>
        </div>   
        <div style="clear:both;"></div>     
      </div>
