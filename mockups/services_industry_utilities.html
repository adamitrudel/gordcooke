...
<Title>Gord Cooke | Industry Specific Benefits - Utilities &amp; Government agencies</Title>
	...
	<div id="inner_col-left">
	  <div id="subsubmenu">
	    <ul>
	      ...
	      <li><a href="services_industry_builders.php">BUILDERS</a></li>
	      <li><a href="services_industry_manufacturers.php">MANUFACTURERS</a></li>
	      <li><a href="services_industry_utilities.php"><strong>UTILITIES & GOVERNMENT AGENCIES</strong></a></li>
	      <li><a href="services_industry_supliers.php">SUPPLIERS & TRADE CONTRACTORS</a></li>
        </ul>
      </div>
  </div>
	<div id="inner_col-right">
<h1><img src="images/inner_photos/success-stories.jpg" width="169" height="312" align="right" />UTILITIES & GOVERNMENT AGENCIES</h1>
             <ul>
               <li>Helping evaluate and field testing new innovative building products
               </li>
               <li>Training of industry representatives on how to approach and work at various levels within the building industry                 </li>
               <li> Education and liaison with building code officials, government agencies to assist in the introduction of programs and products</li>
               <li>Assistance with the development of marketing messages and program elements to the industry</li></ul>
  </div>
<div style="clear:both;"></div>
</div>
