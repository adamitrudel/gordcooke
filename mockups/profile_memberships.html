...
<Title>Gord Cooke | Profile - Memberships &amp; Awards</Title>
	...
	<div id="menu_container">
		<div id="mainmenu">
		  <div class="button" style="padding:0px;padding-left:40px;width:120px;text-align:center;">
			...
			">profile</a>
			<div id="sub_profile" style="display:block;visibility:visible;">
       	  <div class="sm"><a href="/profile_biography.php">Biography</a></div>
                ...
                <div class="sm" style="background-image:url(images/bg_sm-over.png);"><a href="/profile_memberships.php">Membership &amp; awards</a></div>
			</div>
	      </div>
...
<div id="container_inner">
  <div id="header-inner"><img src="images/headers/profile.jpg" alt="Contact" width="980" height="96" /></div>
  ...
  <div id="inner_col-right">
    <h1><img src="images/inner_photos/success-stories.jpg" width="169" height="312" align="right" />MEMBERSHIPS & AWARDS</h1>
<p>Gord has achieved a high standard of recognition and respect from his peers in the building industry over the last 20 years. Here is a list of his industry association memberships and some awards he has received.             </p>
           <p><strong>Memberships :             </strong></p>
           <p><strong>PEO - </strong>Professional Engineers of Ontario<br />
             <strong>HRAI</strong> - Heating Refrigeration and Air Conditioning Institute of Canada
             <br />
             <strong>OHBA</strong> - 	Ontario Home Builders Association
             <br />
             <strong>CHBA</strong> - Canadian Home Builders Association
             <br />
             <strong>CaGBC</strong> - Canadian Green Building Council
             <br />
             <strong>HPBAC</strong> - Hearth Patio BBQ Association of Canada
             <br />
             <strong>OHAO</strong> - Occupational Hygiene Association of Ontario
             <br />
             <strong>CSA</strong> - Canadian Standards Association, Technical Committee for Heating Ventilation Air            Conditioning and Refrigeration
             Previous Chairman of the CSA F326 Residential Mechanical Ventilation Sub Committee
             <br />
             <strong>CMHC</strong> - Canada Mortgage and Housing Corp., International Housing Technology Transfer Team
             <br />
             <strong>CRESNET</strong> - Canadian Residential Energy Services Network
             <br />
             <strong>EEBA</strong> - Energy and Environmental Building Association, Board Member
             <br />
             <strong>CPSA</strong> - Canadian Professional Sales Association             </p>
           <p><strong>Awards :             </strong></p>
           <p>EnerQuality Corp./ OHBA  – Hall of Fame Inductee 2007
             <br />
             Energy Evaluator of the Year<br />
R-2000 Evaluator of the Year </p>
  </div>
