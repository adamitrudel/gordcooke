...
<Title>Gord Cooke | Cooke Report - Training Workshops</Title>
...
<div id="logo"><a href="/index.php" title="Gord Cooke - Building Knowledge"><img src="/images/logo.gif" alt="Gord Cooke - Building Knowledge" width="171" height="130" /></a></div>
	<div id="menu_container">
      ...
      <a href="#" onmouseover="
			...
			MM_changeProp('sub_media','','visibility','hidden','DIV')
			">cooke report</a>
				<div id="sub_cooke" style="display:block;visibility:visible;">
					<div class="sm" style="background-image:url(images/bg_sm-over.png);"><a href="/cooke-report_training.php">Training workshops</a></div>
...
<div id="header-inner"><img src="images/headers/cooke-report.jpg" alt="Contact" width="980" height="96" /></div>
...
<h1><img src="images/inner_photos/success-stories.jpg" width="169" height="312" align="right" />TRAINING WORKSHOPS</h1>
      <p>Gord Cooke offers comprehensive seminar and workshop-based training programs to help his clients learn to build and sell better homes. These programs range from a systems approach to building better homes to marketing and selling the key features and benefits of those homes once a company has achieved a high standard of building performance.
</p>
      <p>These workshops and seminars are designed for anyone in the construction industry. Clients include home builders, as well as home builder’s associations, manufacturers, architects and utilities who wish to provide training as a value added service to their customers.        </p>
      <p>These customized training programs include :        </p>
      <p> <a href="http://www.buildingknowledge.com/training/CompBS.pdf" target="_blank">Comprehensive Building Science Training</a><br />
        <a href="http://www.buildingknowledge.com/training/UnderstandingGreen.pdf" target="_blank">Do You Want that in Green?</a><br />
        <a href="http://www.buildingknowledge.com/training/MktgandSelling.pdf" target="_blank">Marketing and Selling the Better Built Home</a><br />
        <a href="http://www.buildingknowledge.com/training/MoistureRainMgmt.pdf" target="_blank">Moisture and Rain Management </a></p>
</div>
<div style="clear:both;"></div>
</div>
